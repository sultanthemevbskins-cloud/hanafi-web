...
const platformCards = [
  { title: 'Consumer',   desc: 'Check your CTOS Score, monitor identity theft, compare matched loans, and dispute errors on your credit record.', cta: 'Get free report →',   ctaColor: 'text-[#007b85]', bg: 'linear-gradient(135deg, #e5deff 0%, #d2efe0 100%)', photo: consumerPhoto,   imgAnim: 'anim-consumer'   },
  { title: 'Commercial', desc: 'SMEs and traders, search 1.3M+ companies, run litigation checks, and screen partners for compliance risk.',      cta: 'Search companies →', ctaColor: 'text-[#f15d22]', bg: 'linear-gradient(135deg, #ffe9d0 0%, #fcd0ab 100%)', photo: commercialPhoto, imgAnim: 'anim-commercial' },
  { title: 'Corporate',  desc: 'Bulk credit decisioning, KYC, AML screening, and portfolio monitoring for large enterprises and conglomerates.', cta: 'Talk to sales →',    ctaColor: 'text-[#007b85]', bg: 'linear-gradient(135deg, #e5deff 0%, #d6ccfa 100%)', photo: corporatePhoto,  imgAnim: 'anim-corporate'  },
  { title: 'FI / Banks', desc: 'CCRIS integration, real-time API data services, score analytics, and end-to-end loan origination workflows.',    cta: 'Request a demo →',  ctaColor: 'text-[#007b85]', bg: 'linear-gradient(135deg, #eaecef 0%, #c8d5f8 100%)', photo: fibanksPhoto,   imgAnim: 'anim-fibanks'   },
  { title: 'Global',     desc: 'Cross-border credit intelligence across ASEAN, sanctions, PEP screening, and international business reports.',    cta: 'Explore markets →', ctaColor: 'text-[#007b85]', bg: 'linear-gradient(135deg, #d7efe2 0%, #bce3ce 100%)', photo: globalPhoto,    imgAnim: 'anim-global'    },
]
